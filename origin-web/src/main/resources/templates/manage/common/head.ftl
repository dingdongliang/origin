...
<a href="/index" class="logo">
    ...
    <span class="logo-lg"><b>Dy</b>Enigma</span>
</a>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        ...
                        <ul class="menu">
                            <li>
                                <a href="#">
                                    <i class="fa fa-users text-aqua"></i> 今天加入5名新成员
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-warning text-yellow"></i> 太长的描述
                                    不适合这个页面
                                    可能会给页面带来排版混乱
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-users text-red"></i> 5名新成员已经加入
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-shopping-cart text-green"></i> 产生25份销售记录
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-user text-red"></i> 您修改了您的用户名
                                </a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <a href="#">
                                    ...
                                    <div class="progress xs">
                                        <div class="progress-bar progress-bar-green" style="width: 40%"
                                             role="progressbar"
                                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                                            <span class="sr-only">40% 完成度</span>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <a href="#">
                                    ...
                                    <div class="progress xs">
                                        <div class="progress-bar progress-bar-red" style="width: 60%"
                                             role="progressbar"
                                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                                            <span class="sr-only">60% 完成度</span>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <a href="#">
                                    ...
                                    <div class="progress xs">
                                        <div class="progress-bar progress-bar-yellow" style="width: 80%"
                                             role="progressbar"
                                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                                            <span class="sr-only">80% 完成度</span>
                                        </div>
                                    </div>
                                </a>
                            </li>

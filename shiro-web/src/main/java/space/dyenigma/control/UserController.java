...
import space.dyenigma.shiro.UserRoleListCheck;
...
public class UserController {
     ...
     * @Description : 忘记密码处理页面
     * @author dingdongliang
     * @date 2018/2/16 10:25
     */
     ...
     * @param shiroUser
     * @return java.lang.String
     * @Description : 管理员在后台修改 用户 用户注册,企业用户注册，管理员添加本单位用户、上级用户。
     ...
     * @param shiroUser
     * @return java.lang.String
     * @Description : 管理员在后台添加 用户 用户注册,企业用户注册，管理员添加本单位用户、上级用户。
     * 用户类别：0-企业用户,1-本单位普通用户，2-系统管理员，3-上级单位
     * @author dingdongliang
     * @date 2018/2/15 8:21
     */
     ...
     * @param username
     * @return java.lang.String
     * @Description : 获取role列表，以及当前用户role。
     * @author dingdongliang
     * @date 2018/2/15 8:22
     */
     ...
     * @param username
     * @return java.lang.String
     * @Description : 验证用户登录名是否存在,如果不存在 返回success。
     * @author dingdongliang
     * @date 2018/2/15 8:24
     */

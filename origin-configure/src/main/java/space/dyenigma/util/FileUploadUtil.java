...
import space.dyenigma.util.exception.FileNameLengthLimitExceededException;
import space.dyenigma.util.exception.InvalidExtensionException;
import space.dyenigma.util.security.Coder;
...
public class FileUploadUtil {
    ...
    public static final String upload(HttpServletRequest request, MultipartFile file, BindingResult result,
        ...
        try {
            ...
            LogUtil.logError("file upload error", e);
     ...
     * @param filename
     * @return java.lang.String
     * @Description : 编码文件名,默认格式为： 1、'_'替换为 ' ' 2、hex(md5(filename + now nano time + counter++)) 3、[2]_原始文件名
     * @author dingdongliang
     * @date 2018/2/20 19:34
     */
     ...
     * @param
     * @return java.lang.String
     * @Description : 日期路径 即年/月/日 如2013/01/03
     * @author dingdongliang
     * @date 2018/2/20 19:34
     */
     ...
     * @return boolean
     * @Description : 判断MIME类型是否是允许的MIME类型
     * @author dingdongliang
